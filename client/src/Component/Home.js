    ...
    <div className="flex min-h-screen">
      ...
      <div className="bg-gray-800 text-white w-64 flex-shrink-0 p-4">
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-gray-700 rounded hover:bg-gray-600 transition">
            <Link to="/tree" className="block">Tree</Link>
          </div>
          <div className="p-4 bg-gray-700 rounded hover:bg-gray-600 transition">
            <Link to="/collab" className="block">Collab</Link>
          </div>
          <div className="p-4 bg-gray-700 rounded hover:bg-gray-600 transition">
            <Link to="/upload" className="block">Upload Files</Link>
          </div>
        </div>
      </div>
      ...
      <div className="flex-grow p-8 bg-gray-100">
        <div className="bg-gradient-to-r from-blue-400 to-purple-500 p-6 rounded-lg shadow-lg mb-8">
          <h1 className="text-5xl font-bold text-white mb-4">Welcome to Text Editor</h1>
          <p className="text-xl text-gray-200">A powerful tool for editing and managing your text files with ease.</p>
        </div>
